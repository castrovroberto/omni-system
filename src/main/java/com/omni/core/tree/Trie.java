 ...
 *
 * <p>
 * <b>Interview Question:</b> Used in "Word Search II" (LeetCode #212) and
 * "Implement Trie"
 * (LeetCode #208) - commonly asked to test understanding of tree structures for
 * string problems.
 *
 * <p>
 * <b>Design:</b> Uses fixed-size array for children (26 lowercase letters) for
 * O(1) child
 * lookup.
 *
 * <p>
 ...
 *
 * <ul>
 * <li>Array vs Map for children? Array is O(1) but wastes space for sparse
 * tries
...
public class Trie {
     ...
     *
     * <p>
     * <b>Complexity:</b> O(m) where m is the word length.
     *
     ...
     *
     * <p>
     * <b>Complexity:</b> O(m) where m is the prefix length.
     *
     ...
     *
     * <p>
     * <b>Memory:</b> Each node uses 26 * 8 bytes (references) + 1 byte (boolean) ≈
     * 209 bytes on
     * 64-bit JVM. For sparse tries, consider using Map<Character, TrieNode>
     * instead.
     */
