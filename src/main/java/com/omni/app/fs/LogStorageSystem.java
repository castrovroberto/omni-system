 ...
 *
 * <p>
 * <b>Interview Question:</b> "Design Log Storage System" (LeetCode #635) -
 * commonly asked for
 * Java roles to test understanding of TreeMap and range queries.
 *
 * <p>
 * <b>Design:</b> Uses TreeMap for O(log n) insertion and efficient range
 * retrieval via subMap().
 *
 * <p>
...
public class LogStorageSystem {
    ...
    /** Ordered granularity levels from coarsest to finest. */
    ...
    /**
     * Stores logs by timestamp. TreeMap provides O(log n) insertion and O(log n +
     * k) range queries.
     */
     ...
     *
     * <p>
     * <b>Complexity:</b> O(log n) where n is the number of unique timestamps.
     *
     ...
     *
     * <p>
     * <b>Complexity:</b> O(log n + k) where n is the number of timestamps and k is
     * the result
     * size.
     *
     * <p>
     * <b>Example:</b> With granularity "Day", timestamps "2017:01:01:00:00:00" and
     * "2017:01:01:23:59:59" are treated as equivalent since we only compare up to
     * the day.
     *
