...
class LogStorageSystemTest {
  ...
  class RetrieveTests {
    ...
    void retrieve_yearGranularity_matchesYear() {
      List<Integer> result =
          logStorage.retrieve("2016:01:01:01:01:01", "2017:01:01:23:00:00", "Year");
    ...
    void retrieve_hourGranularity_matchesHour() {
      List<Integer> result =
          logStorage.retrieve("2017:01:01:23:00:00", "2017:01:01:23:59:59", "Hour");
    ...
    void retrieve_secondGranularity_exactMatch() {
      List<Integer> result =
          logStorage.retrieve("2017:01:01:23:59:59", "2017:01:01:23:59:59", "Second");
    ...
    void retrieve_noMatch_emptyList() {
      List<Integer> result =
          logStorage.retrieve("2020:01:01:00:00:00", "2020:12:31:23:59:59", "Year");
    ...
    void retrieve_dayGranularity_matchesSameDay() {
      List<Integer> result =
          logStorage.retrieve("2017:01:01:00:00:00", "2017:01:01:23:59:59", "Day");
  ...
  class EdgeCases {
    ...
    void retrieve_emptyStorage_emptyResult() {
      List<Integer> result =
          logStorage.retrieve("2017:01:01:00:00:00", "2017:12:31:23:59:59", "Year");
